...
class SImpleTestOnTE {
    ...
    fun sImpleTestOnTE() {
        ...
        appCompatEditText.perform(scrollTo(), replaceText("г"), closeSoftKeyboard())
        ...
        val appCompatEditText2 = onView(
            allOf(
                withId(AppResources.id.editText), withText("г"),
                childAtPosition(
                    allOf(
                        withId(AppResources.id.scrollView2),
                        childAtPosition(
        ...
        appCompatEditText2.perform(scrollTo(), replaceText("ггcentar@ff.uns.ac.rs"))

        val appCompatEditText3 = onView(
            allOf(
                withId(AppResources.id.editText), withText("ггcentar@ff.uns.ac.rs"),
                childAtPosition(
                    allOf(
                        withId(AppResources.id.scrollView2),
                        childAtPosition(
        ...
        appCompatEditText4.perform(
            scrollTo(),
            replaceText("ггcentar@ff.uns.ac.rscentar@ff.uns.ac.rs")
        )

        val appCompatEditText5 = onView(
            allOf(
                withId(AppResources.id.editText), withText("ггcentar@ff.uns.ac.rscentar@ff.uns.ac.rs"),
                childAtPosition(
                    allOf(
                        withId(AppResources.id.scrollView2),
                        childAtPosition(
        ...
        editText.check(matches(withText("ггcentar@ff.uns.ac.rscentar@ff.uns.ac.rs")))
    }
